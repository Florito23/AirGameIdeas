...
:: Android packaging
set AND_CERT_NAME="Gesture Recognition Test"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\GestureRecognitionTest.p12
...
set IOS_PROVISION=cert\GestureRecognitionTest.mobileprovision
...
set APP_ID=air.GestureRecognitionTest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=GestureRecognitionTest
