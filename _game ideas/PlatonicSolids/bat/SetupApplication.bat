...
:: Android packaging
set AND_CERT_NAME="PlatonicSolids"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\PlatonicSolids.p12
...
set IOS_PROVISION=cert\PlatonicSolids.mobileprovision
...
set APP_ID=air.PlatonicSolids

:: Output packages
set DIST_PATH=dist
set DIST_NAME=PlatonicSolids
