...
:: Android packaging
set AND_CERT_NAME="Context3dStudies"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Context3dStudies.p12
...
set IOS_PROVISION=cert\Context3dStudies.mobileprovision
...
set APP_ID=air.Context3dStudies

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Context3dStudies
