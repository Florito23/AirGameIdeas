...
:: Android packaging
set AND_CERT_NAME="NapePlay"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\NapePlay.p12
...
set IOS_PROVISION=cert\NapePlay.mobileprovision
...
set APP_ID=air.NapePlayHex

:: Output packages
set DIST_PATH=dist
set DIST_NAME=NapePlay
