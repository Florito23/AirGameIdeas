package tests.soundpitchingtest 
{
	 ...
	 */
	public class SoundPitching extends Sprite 
	{
		
		//[Embed(source="RnBoppeShort.mp3")]
		[Embed(source="RnBoppe.mp3")]
		...
		private var pitchedSound:Sound;
		//private var noise:Sound;
		//private var sine:Sound;
		
		
		public function SoundPitching() 
		{
		...
		{
			removeChildren();
			stage.removeEventListener(MouseEvent.MOUSE_MOVE, onMouseMovePitch);
		...
		private function init(e:Event):void 
		{
			...
			trace("init");
			stage.addEventListener(MouseEvent.MOUSE_MOVE, onMouseMovePitch);
		...
		private function onMouseMovePitch(e:MouseEvent):void 
		{
