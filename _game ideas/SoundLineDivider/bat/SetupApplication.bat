...
:: Android packaging
set AND_CERT_NAME="SoundLineDivider"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SoundLineDivider.p12
...
set IOS_PROVISION=cert\SoundLineDivider.mobileprovision
...
set APP_ID=air.SoundLineDivider

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SoundLineDivider
