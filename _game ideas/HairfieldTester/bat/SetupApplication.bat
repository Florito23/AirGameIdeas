...
:: Android packaging
set AND_CERT_NAME="HairfieldTester"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\HairfieldTester.p12
...
set IOS_PROVISION=cert\HairfieldTester.mobileprovision
...
set APP_ID=air.HairfieldTester

:: Output packages
set DIST_PATH=dist
set DIST_NAME=HairfieldTester
